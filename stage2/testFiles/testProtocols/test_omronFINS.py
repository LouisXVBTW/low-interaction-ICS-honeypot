...
from omronFINS import omronFINS
...
class testSampleProtocol(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.PORT = 9600 #random unused port for testing
    ...
    def test_serverReply(self) -> None:
        ...
        thread = threading.Thread(target=omronFINS.handle_client, args=(self, conn, addr))
        thread.daemon = True
        thread.start()
