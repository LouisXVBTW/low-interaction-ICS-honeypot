...
from tridiumNiagraFox import tridiumNiagraFox
...
class testSampleProtocol(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.PORT = 1911 #random unused port for testing
    ...
    def test_serverReply(self) -> None:
        ...
        thread = threading.Thread(target=tridiumNiagraFox.handle_client, args=(self, conn, addr))
        thread.daemon = True
        thread.start()
